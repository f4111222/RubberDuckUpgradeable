...
contract RubberDuckBathParty is Initializable, ERC721Upgradeable, OwnableUpgradeable {
  ...
  mapping(address => uint256) public addressMintedBalance;
    ...
    function initialize() initializer public {
        __ERC721_init("RubberDuckBathParty", "RDBP");
  ...
  function earlyMint(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable {
    ...
    require(MerkleProofUpgradeable.verify(_merkleProof, merkleRoot, leaf), "invalid proof, you're not on the pregame list.");
